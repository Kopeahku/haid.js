...
function shareDoa(doa) {
    const whatsappUrl = `https://wa.me/?text=Downoad aplikasinya https://play.google.com/store/apps/details?id=com.alquranindonesiaterlengkap${encodeURIComponent(doa)}`;
