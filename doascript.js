...
function shareDoa(doa) {
    const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(doa)-Downoad aplikasinya https://play.google.com/store/apps/details?id=com.alquranindonesiaterlengkap}`;
